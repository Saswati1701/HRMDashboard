    ...
    <div className='content'>
      <div className="left-dashboard">
        ...
        <div className='insight-cards-container'>
          <Insightcard color="green" text="Total Applications" number="5672" iconColor="#38CB89" increase="+14% inc"  image={GreenChart} />
          <Insightcard color="red" text="Shortlisted Candidates" number="3045" iconColor="#FFA600" increase="+14% inc"  image={YellowChart} />
          <Insightcard color="blue" text="Rejected Candidates" number="1055" iconColor="#FF5630" increase="+14% inc" image={OrangeChart} />
        </div>
